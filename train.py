...
def train():
    ...
    sys_utils.mkdirs(config.get_path("models"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--network", type=str, help="网络的配置文件", default="/datav/wish/yolov5/models/yolov5s.yaml")
    parser.add_argument("--weight", type=str, help="预训练模型", default="")   
    parser.add_argument("--dataset", type=str, help="数据集，可以选择VOC、COCO", default="VOC")
    ...
    parser.add_argument("--device", type=int, help="GPU号", default=2)
